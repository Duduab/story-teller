...
function App() {
  ...
  const handleSubmit = (age, animal) => {
    ...
    const genAI = new GoogleGenerativeAI("AIzaSyCCtHDVsfqEZYxkbyZFznJRS_yyJCL5Guo");
  ...
  const createImages = () => {
    ...
    const options = {
      ...
      headers: {
        ...
        authorization: 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6IjM4MmZlYmRhODVmODNkMGFjNDkxYzg0YjBkMmM5MTljIiwiY3JlYXRlZF9hdCI6IjIwMjQtMDMtMTJUMTM6MzQ6NDAuNDQxMzM2In0.1cJaM9FYOUI8YToNeOKHkVGP2drHhZyAGUOrO_FYh3E'
      },
      data: {
        aspect_ratio: 'square',
        guidance_scale: 7.5,
